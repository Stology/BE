...
public class CustomOAuthService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(
        ...
        try {
            ...
            throw new MemberException(MemberErrorCode.MEMBER_NOT_SUPPORTED_SOCIAL_PROVIDER);
        }
        ...
        switch (providerId) {
            ...
            default -> throw new MemberException(MemberErrorCode.MEMBER_NOT_SUPPORTED_SOCIAL_PROVIDER);
        }
